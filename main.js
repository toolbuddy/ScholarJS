...
program
    ...
    .option('-P, --public <PUBLICATION>', 'Results must have appeared in this publication.')
...
if (!program.help) {
    console.log(
        ...
        chalk.white('    -P[--public] <PUBLICATION> : Results must have appeared in this publication.\n'),
